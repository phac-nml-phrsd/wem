...
model_prm_example <- function() {
    ...
    x = list(
        ...
        transm.v =  '1; 0.20' ,  # break values (multiplier for R0) for change in contact rate
        ...
        vacc.eff.time = '30 ; 40', # break times for change in vacc. effectiveness values
        vacc.eff.inf.v = '1.0 ; 1.0', # break values (multiplier) for change in vacc. effectiveness in infection given exposure 
        vacc.eff.symp.v = '1.0 ; 1.0', # break values (multiplier) for change in vacc. effectiveness in symptomatic given exposure 
        vacc.eff.hosp.v = '1.0 ; 1.0', # break values (multiplier) for change in vacc. effectiveness in hospitalization given exposure 
